...
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///database.db' #'mysql+pymysql://' + db_creds['mysql_user'] + ':' + db_creds['mysql_pasword'] + '@' + db_creds['mysql_host'] + '/' + db_creds['mysql_db']
...
def promote_user(current_user, public_id):
	...
	user.admin = True
	db.session.commit()
	return jsonify({'Message: ': "The user has been promted"})
